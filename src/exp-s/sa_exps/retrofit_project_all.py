...
for language in languages:
    ...
    save_results(f'{ppmi_type}/{alignment_type}/svm_{kernel_type}/{language}/svm_{kernel_type}.txt', y_test, test_predictions_glove)
    ...
    save_results(f'{ppmi_type}/{alignment_type}/svm_{kernel_type}/{language}/svm_{kernel_type}.txt', y_test, test_predictions_ppmi)
    ...
    save_results(f'{ppmi_type}/{alignment_type}/svm_{kernel_type}/{language}/svm_{kernel_type}.txt', y_test, test_predictions_glove_ppmi)